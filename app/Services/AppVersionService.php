...
final class AppVersionService
{
    ...
    public const PACKAGE_LABEL = 'RS Connect 36.27.24 — Agenda interna conversacional e disponibilidade automática';
    public const REQUIRED_MIGRATION = '101_agent_scheduling_specialist_routing.sql';
