...
final class AppVersionService
{
    ...
    // RS Connect 36.27.19 — continuidade da agenda e verdade única de data/horário.
    ...
    public const PACKAGE_LABEL = 'RS Connect 36.27.19 — Agenda coerente entre conversa e calendário';
