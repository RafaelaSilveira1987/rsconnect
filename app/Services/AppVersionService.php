...
final class AppVersionService
{
    ...
    // RS Connect 36.27.20 — preservação de mensagens rápidas no fluxo de agenda.
    ...
    public const PACKAGE_LABEL = 'RS Connect 36.27.20 — Agenda resiliente a mensagens rápidas';
