...
final class AppVersionService
{
    ...
    // RS Connect 36.27.23 — correção do webhook Asaas: payment.checkoutSession e recusas financeiras.
    // RS Connect 36.27.24 — agenda interna consulta automaticamente a disponibilidade no fluxo conversacional.
    // RS Connect 36.27.25 — agenda conversacional com escolha entre Prompt Studio e formulário configurável.
    // RS Connect 36.27.26 — agenda assertiva: preferência não ocupa calendário, slot interno exato é validado e confirmação nunca é textual sem persistência.
    ...
    // RS Connect 36.27.11 — bloqueio comercial canônico e métricas live do n8n.
    // RS Connect 36.27.12 — reativação assistida e vigilância do workflow Monitor operacional no n8n.
    // RS Connect 36.27.13 — identidade fixa do Monitor operacional e detecção de workflows duplicados no n8n.
    // Marcador histórico do pacote: RS Connect 36.27.13 — Monitor operacional com ID único.
    // RS Connect 36.27.14 — recuperação integral do OperationalAlertService e ledger do resumo diário (100_operational_health_digest_delivery.sql).
    // RS Connect 36.27.15 — tela compacta de agentes e correção do especialista de agendamento.
    // RS Connect 36.27.16 — confirmação conversacional persiste o agendamento real na agenda.
    // RS Connect 36.27.17 — intenção comercial de agenda vira pré-agendamento real e falhas ficam fail-closed.
    // RS Connect 36.27.21 — religação segura de pré-agendamento órfão à conversa ativa.
    // Compatibilidade histórica: RS Connect 36.27.18 — agenda persistida antes da resposta da IA.
    // Compatibilidade histórica: REQUIRED_MIGRATION = '101_agent_scheduling_specialist_routing.sql';
    ...
    // Compatibilidade histórica: PACKAGE_LABEL = 'RS Connect 36.32.2 — Hotfix do cálculo de SLA';
    // Compatibilidade histórica: REQUIRED_MIGRATION = '113_human_first_response_report_consistency.sql';
    // RS Connect 36.33.0 — Production Readiness Fase B: reconciliação auditável e confiabilidade Evolution.
    public const PACKAGE_LABEL = 'RS Connect 36.33.0 — Production Readiness: Evolution Reliability';
    public const REQUIRED_MIGRATION = '114_evolution_reconciliation_observability.sql';
