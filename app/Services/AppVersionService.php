...
final class AppVersionService
{
    ...
    // RS Connect 36.18.0 — respostas locais, cache exato opcional e relatórios PDF corrigidos.
    ...
    public const PACKAGE_LABEL = 'RS Connect 36.18.0 — Economia de IA fase 2 e relatórios corrigidos';
