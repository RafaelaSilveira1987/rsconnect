...
final class AppVersionService
{
    ...
    // RS Connect 36.27.18 — guarda determinística da agenda antes de qualquer resposta da IA.
    ...
    public const PACKAGE_LABEL = 'RS Connect 36.27.18 — Agenda persistida antes da resposta da IA';
