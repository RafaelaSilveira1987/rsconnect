...
final class AppVersionService
{
    ...
    public const PACKAGE_LABEL = 'HOTFIX 32.1.2';
    public const REQUIRED_MIGRATION = '035_admin_company_tracking.sql';
    ...
    private function checks(): array
    {
        ...
        $checks[] = $this->check(
            ...
            count($missingTables) === 0 ? 'Estrutura principal até o HOTFIX 32.1.2 encontrada.' : 'Tabelas ausentes: ' . implode(', ', $missingTables),
            'Rodar as migrations pendentes até a 035, conforme o pacote implantado.'
        );
