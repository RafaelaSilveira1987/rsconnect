...
final class AppVersionService
{
    ...
    public const PACKAGE_LABEL = 'HOTFIX 32.1.1';
    ...
    private function checks(): array
    {
        ...
        $checks[] = $this->check(
            ...
            count($missingTables) === 0 ? 'Estrutura principal até o HOTFIX 32.1.1 encontrada.' : 'Tabelas ausentes: ' . implode(', ', $missingTables),
