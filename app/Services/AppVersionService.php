...
final class AppVersionService
{
    ...
    // RS Connect 36.24.2 — cabeçalho User-Agent obrigatório em todas as chamadas ao Asaas.
    ...
    public const PACKAGE_LABEL = 'RS Connect 36.24.2 — compatibilidade User-Agent da API Asaas';
