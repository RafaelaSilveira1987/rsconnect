...
final class OperationalAlertService
{
    ...
    private function label(string $k): string { return ['evolution'=>'WhatsApp / Evolution','openai'=>'OpenAI / IA','n8n'=>'n8n','backup'=>'Backup','billing_cron'=>'Cron de cobrança','ai_reprocess'=>'Fila da IA','reporting'=>'Relatórios','database'=>'Banco de dados','migrations'=>'Migrations','calendar'=>'Google Agenda','payments'=>'Pagamentos','webhooks'=>'Webhooks'][$k]??'Operação RS'; }
