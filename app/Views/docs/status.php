...
<div class="report-kpi-grid implementation-kpis" style="margin-top:16px">
    ...
    <article class="card report-kpi"><span>Atualização principal do banco</span><strong><?= View::e($dashboard['required_migration_number'] ?? '—') ?></strong><small><?= View::e($dashboard['required_migration'] ?? '') ?></small></article>
</div>
