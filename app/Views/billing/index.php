        ...
        <div class="admin-module-card-list compact-cards">
            <?php foreach ($plans as $plan): ?>
                <article class="admin-record-card">
                    ...
                    <dl class="admin-record-metrics"><div><dt>Usuários</dt><dd><?= View::e((string) ($plan['limits']['users'] ?? '∞')) ?></dd></div><div><dt>WhatsApps</dt><dd><?= View::e((string) ($plan['limits']['instances'] ?? '∞')) ?></dd></div><div><dt>Assistentes</dt><dd><?= View::e((string) ($plan['limits']['agents'] ?? '∞')) ?></dd></div><div><dt>Interações IA</dt><dd><?= View::e((string) ($plan['limits']['ai_interactions_month'] ?? $plan['limits']['messages_month'] ?? '∞')) ?></dd></div></dl>
