                        ...
                        <div class="agent-operation-section-body agent-behavior-body">
                            ...
                            <div class="agent-behavior-grid">
                                ...
                                <article class="agent-behavior-card">
                                    ...
                                    <label class="field compact-field"><span>Ritmo da conversa</span><select name="conversation_behavior[response_delivery][scope]"><option value="asked_only" <?= ($behaviorDelivery['scope'] ?? 'asked_only') === 'asked_only' ? 'selected' : '' ?>>Responder só ao que foi perguntado e avançar 1 etapa</option><option value="related" <?= ($behaviorDelivery['scope'] ?? '') === 'related' ? 'selected' : '' ?>>Pode antecipar informações relacionadas</option></select><small>No modo recomendado, o assistente responde somente ao assunto do turno atual, não antecipa valor/pagamento e faz apenas a próxima pergunta da Ordem do atendimento antes de esperar o contato.</small></label>
                                    ...
                                    <div class="agent-behavior-example"><b>Exemplo</b><span>1. resposta ao que foi perguntado</span><span>2. próxima pergunta obrigatória</span></div>
                                </article>
                            </div>
