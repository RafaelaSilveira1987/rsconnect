                        ...
                        <div class="agent-operation-section-body agent-behavior-body">
                            ...
                            <div class="agent-behavior-grid">
                                ...
                                <article class="agent-behavior-card">
                                    ...
                                    <label class="field compact-field"><span>Ritmo da conversa</span><select name="conversation_behavior[response_delivery][scope]"><option value="asked_only" <?= ($behaviorDelivery['scope'] ?? 'asked_only') === 'asked_only' ? 'selected' : '' ?>>Responder só ao que foi perguntado e avançar 1 etapa</option><option value="related" <?= ($behaviorDelivery['scope'] ?? '') === 'related' ? 'selected' : '' ?>>Pode antecipar informações relacionadas</option></select><small>No modo recomendado, a Rafa responde à dúvida atual, faz apenas a próxima pergunta da Ordem do atendimento e espera o contato responder.</small></label>
