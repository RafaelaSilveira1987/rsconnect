...
<head>
    ...
    <link rel="stylesheet" href="<?= View::e(Router::url('/assets/css/app.css?v=36.27.20')) ?>">
    <style>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav" aria-label="Navegação principal">
            ...
            <?php if (Auth::isSuperAdmin()): ?>
                ...
                <a class="nav-link<?= $isActive('/agent-blueprints') ?>" href="<?= View::e(Router::url('/agent-blueprints')) ?>"><?= $svgIcon('agent') ?><span>Nichos e blueprints</span></a>
...
<script src="<?= View::e(Router::url('/assets/js/app.js?v=36.27.20')) ?>" defer></script>
</body>
</html>
