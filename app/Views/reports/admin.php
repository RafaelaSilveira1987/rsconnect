...
<section class="card report-section-directory" id="report-directory" aria-label="Navegação dos relatórios">
    <div class="section-heading report-directory-heading">
        <div>
            <span class="eyebrow">Conteúdo do relatório</span>
            <h2>Escolha uma análise ou percorra todos os cards</h2>
            <p>Todos os indicadores ficam visíveis na mesma página. Use os atalhos abaixo para ir direto ao assunto.</p>
        </div>
    </div>
    <nav class="report-section-card-grid">
        <a class="report-section-link" href="#report-growth" data-report-section-link><span class="report-section-number">01</span><strong>Crescimento</strong><small>Novas empresas e movimentação da base.</small></a>
        <a class="report-section-link" href="#report-revenue" data-report-section-link><span class="report-section-number">02</span><strong>Receita</strong><small>Assinaturas, cobranças e valores recebidos.</small></a>
        <a class="report-section-link" href="#report-usage" data-report-section-link><span class="report-section-number">03</span><strong>Uso da plataforma</strong><small>Conversas, mensagens e adoção por empresa.</small></a>
        <a class="report-section-link" href="#report-automation" data-report-section-link><span class="report-section-number">04</span><strong>IA e automações</strong><small>Respostas automáticas, falhas e integrações.</small></a>
        <a class="report-section-link" href="#report-agenda" data-report-section-link><span class="report-section-number">05</span><strong>Agenda</strong><small>Compromissos, confirmações e cancelamentos.</small></a>
        <a class="report-section-link" href="#report-commercial" data-report-section-link><span class="report-section-number">06</span><strong>Comercial RS</strong><small>Pipeline, oportunidades e conversão.</small></a>
    </nav>
</section>
...
<div class="report-section-stack">
    ...
    <section class="card report-content-card executive-report-panel" id="report-growth">
        <header class="report-content-card-header">
            ...
            <div><span class="eyebrow">Crescimento</span><h2>Base e evolução dos clientes</h2><p>Acompanhe novas empresas, clientes ativos e mudanças na base.</p></div>
            <a class="report-back-link" href="#report-directory">Voltar ao índice</a>
        </header>
    ...
    <section class="card report-content-card executive-report-panel" id="report-revenue">
        <header class="report-content-card-header">
            ...
            <div><span class="eyebrow">Receita</span><h2>Assinaturas e cobranças</h2><p>Veja a receita recorrente, valores recebidos e vencimentos recentes.</p></div>
            <a class="report-back-link" href="#report-directory">Voltar ao índice</a>
        </header>
        <div class="executive-report-grid">
    ...
    <section class="card report-content-card executive-report-panel" id="report-usage">
        <header class="report-content-card-header">
            ...
            <div><span class="eyebrow">Uso da plataforma</span><h2>Adoção e movimento por empresa</h2><p>Compare conversas, mensagens e nível de uso entre os clientes.</p></div>
            <a class="report-back-link" href="#report-directory">Voltar ao índice</a>
        </header>
    ...
    <section class="card report-content-card executive-report-panel" id="report-automation">
        <header class="report-content-card-header">
            ...
            <div><span class="eyebrow">IA e automações</span><h2>Qualidade das respostas e integrações</h2><p>Identifique falhas, volume de respostas automáticas e pontos de atenção.</p></div>
            <a class="report-back-link" href="#report-directory">Voltar ao índice</a>
        </header>
        <div class="executive-report-grid">
    ...
    <section class="card report-content-card executive-report-panel" id="report-agenda">
        <header class="report-content-card-header">
            ...
            <div><span class="eyebrow">Agenda</span><h2>Compromissos e conversão</h2><p>Analise confirmações, cancelamentos e uso da agenda pelos clientes.</p></div>
            <a class="report-back-link" href="#report-directory">Voltar ao índice</a>
        </header>
    ...
    <section class="card report-content-card executive-report-panel" id="report-commercial">
        <header class="report-content-card-header">
            ...
            <div><span class="eyebrow">Comercial RS</span><h2>Pipeline e resultado comercial</h2><p>Acompanhe oportunidades abertas, valores e desempenho das etapas.</p></div>
            <a class="report-back-link" href="#report-directory">Voltar ao índice</a>
        </header>
