...
Pacote consolidado até o ZIP 36.2 com HOTFIX 36.2.3.

## Última etapa incluída

HOTFIX 36.2.3 — callback da agenda responde antes de pré-reserva/WhatsApp e elimina falso timeout.
...
Consulte `README-HOTFIX-36.2.3.md` para corrigir o callback assíncrono da agenda sem alterar o workflow Eventos VAGO.
