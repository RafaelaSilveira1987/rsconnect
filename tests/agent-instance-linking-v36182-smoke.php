...
$assert(str_contains($layout, 'app.css?v=36.19.0'), 'cache busting do CSS deve usar a versão atual');
$assert(str_contains($layout, 'app.js?v=36.19.0'), 'cache busting do JS deve usar a versão atual');
