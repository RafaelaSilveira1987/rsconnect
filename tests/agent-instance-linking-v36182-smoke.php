...
$assert(str_contains($layout, 'app.css?v=36.18.3'), 'cache busting do CSS deve usar 36.18.3');
$assert(str_contains($layout, 'app.js?v=36.18.3'), 'cache busting do JS deve usar 36.18.3');
