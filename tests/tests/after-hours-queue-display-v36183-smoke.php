...
$checks = [
    ...
    'banner detalhado na conversa' => str_contains($conversationView, 'after-hours-queue-banner')
        ...
        && str_contains($conversationView, 'Assumir agora'),
    ...
    'estilos responsivos incluídos' => str_contains($css, 'RS Connect 36.18.4')
        && str_contains($css, '.after-hours-queue-banner')
        && str_contains($css, '.after-hours-operation-card'),
    'versão e assets atualizados' => str_contains($version, 'RS Connect 36.18.4')
        && str_contains($layout, 'app.css?v=36.18.4')
        && str_contains($layout, 'app.js?v=36.18.4'),
];
