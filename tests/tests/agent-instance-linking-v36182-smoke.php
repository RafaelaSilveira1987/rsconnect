...
$assert(str_contains($layout, 'app.css?v=36.18.4'), 'cache busting do CSS deve usar 36.18.4');
$assert(str_contains($layout, 'app.js?v=36.18.4'), 'cache busting do JS deve usar 36.18.4');
