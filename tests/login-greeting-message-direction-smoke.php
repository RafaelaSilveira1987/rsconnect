...
$assert(str_contains($version, 'RS Connect 36.8.1'), 'A versão do pacote foi atualizada.');
$assert(str_contains($layout, 'app.js?v=36.8.1'), 'O cache do JavaScript foi renovado.');
