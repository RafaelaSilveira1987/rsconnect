...
$assert(str_contains($version, 'RS Connect 36.12.0'), 'A versão do pacote foi atualizada.');
$assert(str_contains($layout, 'app.js?v=36.12.0'), 'O cache do JavaScript foi renovado.');
