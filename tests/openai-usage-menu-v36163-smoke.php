...
$checks = [
    ...
    'menu do super admin' => str_contains($layout, '<span>Uso e custo da IA</span>') && str_contains($layout, "Router::url('/openai-usage')"),
    'cache bust atual' => preg_match('/app\.css\?v=36\.(16\.3|17\.0|17\.1|17\.2|18\.[0123456]|19\.[0123]|20\.[012])/', $layout) === 1 && preg_match('/app\.js\?v=36\.(16\.3|17\.0|17\.1|17\.2|18\.[0123456]|19\.[0123]|20\.[012])/', $layout) === 1,
    ...
    'view dedicada completa' => str_contains($view, 'Uso diário da OpenAI') && str_contains($view, 'OPENAI_ADMIN_API_KEY') && str_contains($view, 'Atualizar agora'),
    'atalho em credenciais' => str_contains($credentialsView, 'Abrir uso e custo da IA'),
    'pacote atualizado' => preg_match('/RS Connect 36\.(16\.3|17\.0|17\.1|17\.2|18\.[0123456]|19\.[0123]|20\.[012])/', $version) === 1,
