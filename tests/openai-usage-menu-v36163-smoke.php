...
$checks = [
    ...
    'cache bust atual' => preg_match('/app\.css\?v=36\.(16\.3|17\.0|17\.1|17\.2|18\.[0123456]|19\.[01])/', $layout) === 1 && preg_match('/app\.js\?v=36\.(16\.3|17\.0|17\.1|17\.2|18\.[0123456]|19\.[01])/', $layout) === 1,
    ...
    'pacote atualizado' => preg_match('/RS Connect 36\.(16\.3|17\.0|17\.1|17\.2|18\.[0123456]|19\.[01])/', $version) === 1,
