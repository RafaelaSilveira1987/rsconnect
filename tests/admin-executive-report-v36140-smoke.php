...
$assertions = [
    'versão 36.14.0 publicada' => str_contains($version, 'RS Connect 36.14.0')
        && str_contains($version, '074_conversation_message_attachments.sql'),
    'cache global renovado' => str_contains($layout, 'app.css?v=36.14.0')
    ...
    'estilos responsivos incluídos' => str_contains($css, 'v36.14.0 — Painel executivo')
...
echo "OK - painel executivo de relatórios da RS Admin validado na v36.14.0." . PHP_EOL;
