...
$checks = [
    ...
    'versão e migrations históricas atualizadas até 070' => str_contains($version, 'RS Connect 36.11.0')
        && str_contains($version, '071_utc_datetime_contract_compat.sql')
        && str_contains($foundation, 'conversation_service_cycles'),
    'cache visual atualizado' => str_contains($layout, 'app.css?v=36.11.0')
        && str_contains($layout, 'app.js?v=36.11.0'),
];
