...
$checks = [
    ...
    'assets sem cache antigo' => preg_match('/app\.css\?v=36\.(17\.[12]|18\.[0123456]|19\.[012])/', $layout) === 1
        && preg_match('/app\.js\?v=36\.(17\.[12]|18\.[0123456]|19\.[012])/', $layout) === 1,
    'pacote identificado' => preg_match('/RS Connect 36\.(17\.[12]|18\.[0123456]|19\.[012])/', $version) === 1
