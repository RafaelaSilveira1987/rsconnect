...
$availabilitySource = file_get_contents(dirname(__DIR__) . '/app/Services/CalendarAvailabilityService.php');
...
$template = json_decode((string) file_get_contents(dirname(__DIR__) . '/docs/n8n_templates/template-agenda-google-eventos-vago.json'), true);
