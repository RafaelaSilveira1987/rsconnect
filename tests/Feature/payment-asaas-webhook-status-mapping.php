...
$checks = [
    ...
    'Asaas capture refusal is mapped to cancelled' => str_contains($service, "'PAYMENT_CREDIT_CARD_CAPTURE_REFUSED'"),
    'Asaas risk reproval is mapped to cancelled' => str_contains($service, "'PAYMENT_REPROVED_BY_RISK_ANALYSIS'"),
