...
$checks = [
    ...
    'versão 36.27.19 preserva migration 101' =>
        str_contains($version, 'RS Connect 36.27.19')
        && str_contains($version, "REQUIRED_MIGRATION = '101_agent_scheduling_specialist_routing.sql'"),
    'cache de front-end atualizado' =>
        str_contains($layout, 'app.css?v=36.27.19')
        && str_contains($layout, 'app.js?v=36.27.19'),
];
