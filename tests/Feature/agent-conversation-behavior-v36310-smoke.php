...
$check(str_contains($manifest, '"package_version": "36.31.0"') && str_contains($manifest, '"required_migration": "110_conversation_lifecycle_e2e_consistency.sql"'), 'Manifesto da release está coerente.');
