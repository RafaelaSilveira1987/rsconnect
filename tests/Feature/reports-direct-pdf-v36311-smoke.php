...
'manifesto'=>(str_contains($manifest,'"package_version": "36.31.2"')||str_contains($manifest,'"package_version": "36.31.3"')||str_contains($manifest,'"package_version": "36.32.0"'))&&str_contains($manifest,'"package_version": "36.31.1"')];
