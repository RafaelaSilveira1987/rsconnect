...
$serviceSource = (string) file_get_contents(dirname(__DIR__, 2) . '/app/Services/AiAutomationService.php');
$webhookSource = (string) file_get_contents(dirname(__DIR__, 2) . '/app/Controllers/EvolutionWebhookController.php');
$versionSource = (string) file_get_contents(dirname(__DIR__, 2) . '/app/Services/AppVersionService.php');
$afterHoursSource = (string) file_get_contents(dirname(__DIR__, 2) . '/app/Services/AiAfterHoursRecoveryService.php');
