...
$assert(str_contains($js, 'data-agent-channel-link') && str_contains($js, 'data-routing-mode'), 'editor deve manter papel multiagente e vínculo coerentes');
$assert(str_contains($layout, 'app.css?v=36.20.2'), 'cache busting do CSS deve usar a versão atual');
$assert(str_contains($layout, 'app.js?v=36.20.2'), 'cache busting do JS deve usar a versão atual');
