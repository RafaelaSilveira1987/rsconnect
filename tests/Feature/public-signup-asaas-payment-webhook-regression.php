...
$checks = [
    ...
    'PAYMENT refusal keeps existing invoice open for retry' => str_contains($service, "upsertAsaasInvoice(\$session, \$payment, 'open')") && str_contains($service, "billing_status = 'overdue'"),
];
