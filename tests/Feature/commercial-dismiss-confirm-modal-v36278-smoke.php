...
$checks['modal visual é criado pelo app'] = str_contains($js, "className = 'rs-confirm-modal'") && str_contains($js, "rsDialog.openForm(form, event.submitter || null)");
...
$checks['cache assets atualizado'] = str_contains($layout, 'app.css?v=36.27.9') && str_contains($layout, 'app.js?v=36.27.9');
$checks['versão atualizada'] = str_contains($version, "PACKAGE_LABEL = 'RS Connect 36.27.9 — Diálogos visuais padronizados'");
