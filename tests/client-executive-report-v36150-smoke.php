...
$assertions = [
    ...
    'métricas executivas do tenant disponíveis' => str_contains($service, "'responded_conversations'")
        && str_contains($service, "'active_conversations'")
        && str_contains($service, "'attention_conversations'")
    ...
    'oito indicadores principais no cliente' => str_contains($view, 'Conversas atendidas')
    ...
    'gráficos principais incluídos' => str_contains($view, 'Mensagens ao longo do tempo')
    ...
    'equipe agenda e atenção incluídas' => str_contains($view, 'Desempenho da equipe')
        ...
        && str_contains($view, 'Conversas que precisam de atenção'),
    'exportações rápidas disponíveis' => str_contains($view, 'Exportações detalhadas')
